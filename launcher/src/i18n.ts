...
const en = {
  ...
  launchCodexAfterInstall: "Models added. If Codex desktop or the Codex CLI did not open by itself, start it now; the new chatgpt-web models appear in its model picker.",
  ...
  hitlRunning: "HITL server is running. Close its terminal window to stop it.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  launchCodexAfterInstall: "模型已新增。如果 Codex 桌面版或 Codex CLI 没有自动打开，请现在自行启动；新的 chatgpt-web 模型会出现在模型选单中。",
  stepHitl: "启动 HITL 终端",
  ...
  hitlRunning: "HITL 服务器正在运行。关闭其终端窗口即可停止。",
...
const ja: Record<keyof typeof en, string> = {
  ...
  launchCodexAfterInstall: "モデルを追加しました。Codex デスクトップまたは Codex CLI が自動で起動しない場合は、ご自身で起動してください。新しい chatgpt-web モデルがモデル選択に表示されます。",
  ...
  hitlRunning: "HITL サーバーが実行中です。停止するにはターミナルウィンドウを閉じてください。",
...
const ko: Record<keyof typeof en, string> = {
  ...
  launchCodexAfterInstall: "모델을 추가했습니다. Codex 데스크톱이나 Codex CLI가 자동으로 열리지 않으면 직접 실행하세요. 새 chatgpt-web 모델이 모델 선택 목록에 나타납니다.",
  ...
  hitlRunning: "HITL 서버가 실행 중입니다. 중지하려면 터미널 창을 닫으세요.",
...
const zhTW: Record<keyof typeof en, string> = {
  ...
  launchCodexAfterInstall: "模型已新增。如果 Codex 桌面版或 Codex CLI 沒有自動開啟，請現在自行啟動；新的 chatgpt-web 模型會出現在模型選單中。",
  stepHitl: "啟動 HITL 終端",
  ...
  hitlRunning: "HITL 伺服器執行中。關閉它的終端機視窗即可停止。",
